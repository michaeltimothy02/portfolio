...
(function () {
    ...
    lbInner.addEventListener('touchend', () => {
        lastTouchDist = null;
        isPanning = false;
    });
...
initCarousel(
    'customer-carousel', 'dots-customer',
    'arrow-left-customer', 'arrow-right-customer',
    'caption-label-customer', 'caption-desc-customer'
);

initCarousel(
    'admin-carousel', 'dots-admin',
    'arrow-left-admin', 'arrow-right-admin',
    'caption-label-admin', 'caption-desc-admin'
);
